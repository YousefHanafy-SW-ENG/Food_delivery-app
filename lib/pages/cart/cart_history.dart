...
import '../../base/no_data_history.dart';
        ...
        children: [
          ...
          GetBuilder<CartController>(builder: (_cartController){
                  ...
                  child:ListView(
                    children: [
                      for(int i=0; i<itemsPerOrder.length; i++)
                        Container(
                          height: Dimensions.height30*4.63,
                                  ...
                                  Wrap(
                                    ...
                                    children:List.generate(itemsPerOrder[i], (index){
                                      ...
                                      return index<=2? Container(
                                        ...
                                        width:Dimensions.height20*3.98,
            ...
            Container(
                ...
                child: Center(
                    child: const NoDataHistory(text: "You didn't buy anything so far !",imgPath:"assets/image/empty_box.png" ,)));
          })
        ],
      ),
    );
