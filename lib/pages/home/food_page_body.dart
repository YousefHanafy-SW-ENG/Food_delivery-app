...
import 'package:shopapp/controllers/recommended_product_controller.dart';
...
import 'package:shopapp/widgets/app_column.dart';
import 'package:shopapp/widgets/big_text.dart';
import 'package:shopapp/widgets/icon_and_text_widget.dart';
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SmallText(text: "With Egyptian characteristics"),
                                  SizedBox(height: Dimensions.height10,),
                                  Row(
       ...
       GestureDetector(
        ...
        Align(
          ...
          child: Container(
              ...
              margin: EdgeInsets.only(left: Dimensions.radius30,right: Dimensions.radius30,bottom: Dimensions.height30),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Dimensions.radius20),
                  color: Colors.white,
                  boxShadow: [
