...
import 'package:shopapp/base/show_custom_snackbar.dart';
import 'package:shopapp/controllers/auth_controller.dart';
import 'package:shopapp/models/signup_body_model.dart';
          ...
          child: Column(
            children: [
              ...
              AppTextField(
                ...
                hintText: "Password",
                icon: Icons.password_sharp,isObsecure:true
              ),
              SizedBox(height: Dimensions.height20,),
              //your name
              AppTextField(
              ...
              RichText(
                text: TextSpan(
                  ...
                  style: TextStyle(
                    color: Colors.grey[500],
                    fontSize: Dimensions.font16+Dimensions.font16/6,
                  ),
                ),
              ),
              Wrap(
                children: List.generate(3, (index) => Padding(
                  ...
                  child: CircleAvatar(
                    radius: Dimensions.radius20+Dimensions.radius20/6,
                    backgroundImage: AssetImage(
