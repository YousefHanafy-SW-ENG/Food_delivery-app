...
import 'package:shopapp/widgets/exandable_text_widget.dart';
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  BigText(text: "\$ ${product.price!} X  ${controller.inCarItems} ",color: AppColors.mainBlackColor,size: Dimensions.font26,),
                  GestureDetector(
                    onTap: (){
                      print("I am tapped");
